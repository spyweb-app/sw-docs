...
SpyWeb includes a test runner for `test_*` functions defined in your Lua hooks. Each test runs in an isolated Lua VM with a temporary database (see [Lua Testing](/testing) for writing tests).
