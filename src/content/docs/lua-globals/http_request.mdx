...
<FunctionSignature name="http_request" params="options" async />
...
- [http_get](/lua-globals/http_get) - Simple HTTP GET (no proxy/timeout)
- [http_post](/lua-globals/http_post) - Simple HTTP POST (no proxy/timeout)
